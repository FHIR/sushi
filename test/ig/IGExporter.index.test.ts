...
describe('IGExporter', () => {
  ...
  describe('#index', () => {
    ...
    it('should use config.indexPageContent to generate an index.md file', () => {
      ...
      expect(content).toMatch(/^\*\s+WARNING: DO NOT EDIT THIS FILE\s+\*$/m);
      expect(content).toMatch(
        /^\*\s+To change the contents of this file, edit the "indexPageContent" attribute in the tank config.yaml file\s+\*/m
      );
      expect(content).toMatch(
    ...
    it('should log a warning if config.indexPageContent defined and user provided index file', () => {
      ...
      expect(loggerSpy.getLastMessage('warn')).toMatch(
        /Found both an "indexPageContent" property in config\.yaml and an index file.*File: .*index.md/s
      );
    });
  });
});
