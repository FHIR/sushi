...
describe('IGExporter', () => {
  ...
  describe('#simple-ig', () => {
    ...
    it('should generate an index.md with the package description', () => {
      ...
      expect(content).toMatch(/<!-- index.md/);
      expect(content).toMatch(
        /\{% comment %\}.+WARNING: DO NOT EDIT THIS FILE.+\{% endcomment %\}/
      );
      expect(content).toMatch(
        /\{% comment %\}.+This index\.md file was generated from the "description" in package.json\..+\{% endcomment %\}/
      );
    ...
    it('should generate a default menu.xml', () => {
      ...
      expect(content).toMatch(/<!-- menu.xml/);
      expect(content).toMatch(
        /\{% comment %\}.+WARNING: DO NOT EDIT THIS FILE.+\{% endcomment %\}/
      );
      expect(content).toMatch(
        /\{% comment %\}.+This menu\.xml file is a generic menu provided by SUSHI\..+\{% endcomment %\}/
      );
  ...
  describe('#customized-ig', () => {
    ...
    it('should include any additional user-provided files in includes', () => {
      ...
      expect(content).toMatch(/<!-- other.xml/);
      expect(content).toMatch(
        /\{% comment %\}.+WARNING: DO NOT EDIT THIS FILE.+\{% endcomment %\}/
      );
      expect(content).toMatch(
    ...
    it('should include additional user-provided pages of valid file type', () => {
      ...
      expect(otherContent).toMatch(/<!-- other-page.md/);
      ...
      expect(unsupportedContent).not.toMatch(
        /\{% comment %\}.+WARNING: DO NOT EDIT THIS FILE.+\{% endcomment %\}/
      );
  ...
  describe('#customized-ig-with-index-xml', () => {
    ...
    it('should use the user-provided index.xml if it exists', () => {
      ...
      expect(fs.existsSync(indexPath)).toBeTruthy();
      const content = fs.readFileSync(indexPath, 'utf8');
      expect(content).toMatch(/<!-- index.xml/);
      expect(content).toMatch(
        /\{% comment %\}.+WARNING: DO NOT EDIT THIS FILE.+\{% endcomment %\}/
      );
      expect(content).toMatch(
