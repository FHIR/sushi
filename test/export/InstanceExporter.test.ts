...
describe('InstanceExporter', () => {
  ...
  describe('#exportInstance', () => {
    ...
    // Ideally, this should work, but it isn't implemented yet.
    // Similarly, when referencing a contained source created like this, the reference cannot find the definition
    // and falls back to just assigning the entity in the Reference() as a string.
    it.skip('should assign a Canonical as a #id fragment when referring to a contained resource created directly on the instance', () => {
      // Instance: MyQuestionnaire
      // InstanceOf: Questionnaire
      const questionnaire = new Instance('MyQuestionnaire');
      questionnaire.instanceOf = 'Questionnaire';
