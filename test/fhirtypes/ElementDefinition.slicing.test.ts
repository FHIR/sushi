...
describe('ElementDefinition', () => {
  ...
  describe('#addSlice', () => {
    it('should add slices when a slicing is present', () => {
      ...
      expect(systolicBP.type).toEqual([{ _code: 'BackboneElement' }]);
      ...
      expect(diastolicBP.type).toEqual([{ _code: 'BackboneElement' }]);
    ...
    it('should add slices for specific types in a choice', () => {
      ...
      expect(quantity.type).toEqual([{ _code: 'Quantity' }]);
      ...
      expect(integer.type).toEqual([{ _code: 'integer' }]);
