...
var literalNames = [ null, null, null, null, null, null, null, null, null, 
                     ...
                     "'include'", "'exclude'", "'valueset'", "'system'", 
                     "'='", "'*'", "':'", "','" ];
...
var symbolicNames = [ null, "KW_ALIAS", "KW_PROFILE", "KW_EXTENSION", "KW_INSTANCE", 
                      ...
                      "KW_EXCLUDE", "KW_VSREFERENCE", "KW_SYSTEM", "EQUAL", 
                      "STAR", "COLON", "COMMA", "STRING", "MULTILINE_STRING", 
                      "NUMBER", "UNIT", "CODE", "DATETIME", "TIME", "CARD", 
                      "REFERENCE", "CARET_SEQUENCE", "REGEX", "COMMA_DELIMITED_SEQUENCES", 
...
var ruleNames =  [ "doc", "entity", "alias", "profile", "extension", "sdMetadata", 
                   ...
                   "caretValueRule", "vsComponent", "vsTerm", "vsReference", 
                   "vsFilter", "filterDefinition", "filterOperator", "filterValue", 
...
FSHParser.KW_VSREFERENCE = 32;
FSHParser.KW_SYSTEM = 33;
FSHParser.EQUAL = 34;
FSHParser.STAR = 35;
FSHParser.COLON = 36;
FSHParser.COMMA = 37;
FSHParser.STRING = 38;
FSHParser.MULTILINE_STRING = 39;
FSHParser.NUMBER = 40;
FSHParser.UNIT = 41;
FSHParser.CODE = 42;
FSHParser.DATETIME = 43;
FSHParser.TIME = 44;
FSHParser.CARD = 45;
FSHParser.REFERENCE = 46;
FSHParser.CARET_SEQUENCE = 47;
FSHParser.REGEX = 48;
FSHParser.COMMA_DELIMITED_SEQUENCES = 49;
FSHParser.SEQUENCE = 50;
FSHParser.WHITESPACE = 51;
FSHParser.BLOCK_COMMENT = 52;
FSHParser.LINE_COMMENT = 53;
...
FSHParser.RULE_vsReference = 31;
FSHParser.RULE_vsFilter = 32;
FSHParser.RULE_filterDefinition = 33;
FSHParser.RULE_filterOperator = 34;
FSHParser.RULE_filterValue = 35;
FSHParser.RULE_path = 36;
FSHParser.RULE_paths = 37;
FSHParser.RULE_caretPath = 38;
FSHParser.RULE_flag = 39;
FSHParser.RULE_strength = 40;
FSHParser.RULE_value = 41;
FSHParser.RULE_item = 42;
FSHParser.RULE_code = 43;
FSHParser.RULE_quantity = 44;
FSHParser.RULE_ratio = 45;
FSHParser.RULE_ratioPart = 46;
FSHParser.RULE_bool = 47;
FSHParser.RULE_targetType = 48;
...
VsComponentContext.prototype.vsTerm = function() {
    return this.getTypedRuleContext(VsTermContext,0);
};

VsComponentContext.prototype.vsReference = function() {
    return this.getTypedRuleContext(VsReferenceContext,0);
};

VsComponentContext.prototype.vsFilter = function() {
    return this.getTypedRuleContext(VsFilterContext,0);
};
...
function VsReferenceContext(parser, parent, invokingState) {
	if(parent===undefined) {
	    parent = null;
	}
	if(invokingState===undefined || invokingState===null) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = FSHParser.RULE_vsReference;
    return this;
}

VsReferenceContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
VsReferenceContext.prototype.constructor = VsReferenceContext;

VsReferenceContext.prototype.STAR = function() {
    return this.getToken(FSHParser.STAR, 0);
};

VsReferenceContext.prototype.KW_VSREFERENCE = function() {
    return this.getToken(FSHParser.KW_VSREFERENCE, 0);
};

VsReferenceContext.prototype.SEQUENCE = function() {
    return this.getToken(FSHParser.SEQUENCE, 0);
};

VsReferenceContext.prototype.KW_INCLUDE = function() {
    return this.getToken(FSHParser.KW_INCLUDE, 0);
};

VsReferenceContext.prototype.KW_EXCLUDE = function() {
    return this.getToken(FSHParser.KW_EXCLUDE, 0);
};

VsReferenceContext.prototype.enterRule = function(listener) {
    if(listener instanceof FSHListener ) {
        listener.enterVsReference(this);
	}
};

VsReferenceContext.prototype.exitRule = function(listener) {
    if(listener instanceof FSHListener ) {
        listener.exitVsReference(this);
	}
};

VsReferenceContext.prototype.accept = function(visitor) {
    if ( visitor instanceof FSHVisitor ) {
        return visitor.visitVsReference(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
FSHParser.VsReferenceContext = VsReferenceContext;

FSHParser.prototype.vsReference = function() {

    var localctx = new VsReferenceContext(this, this._ctx, this.state);
    this.enterRule(localctx, 62, FSHParser.RULE_vsReference);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 316;
...
function VsFilterContext(parser, parent, invokingState) {
	if(parent===undefined) {
	    parent = null;
	}
	if(invokingState===undefined || invokingState===null) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = FSHParser.RULE_vsFilter;
    return this;
}

VsFilterContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
VsFilterContext.prototype.constructor = VsFilterContext;

VsFilterContext.prototype.STAR = function() {
    return this.getToken(FSHParser.STAR, 0);
};

VsFilterContext.prototype.filterDefinition = function() {
    return this.getTypedRuleContext(FilterDefinitionContext,0);
};

VsFilterContext.prototype.KW_INCLUDE = function() {
    return this.getToken(FSHParser.KW_INCLUDE, 0);
};

VsFilterContext.prototype.KW_EXCLUDE = function() {
    return this.getToken(FSHParser.KW_EXCLUDE, 0);
};

VsFilterContext.prototype.enterRule = function(listener) {
    if(listener instanceof FSHListener ) {
        listener.enterVsFilter(this);
	}
};

VsFilterContext.prototype.exitRule = function(listener) {
    if(listener instanceof FSHListener ) {
        listener.exitVsFilter(this);
	}
};

VsFilterContext.prototype.accept = function(visitor) {
    if ( visitor instanceof FSHVisitor ) {
        return visitor.visitVsFilter(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
FSHParser.VsFilterContext = VsFilterContext;

FSHParser.prototype.vsFilter = function() {

    var localctx = new VsFilterContext(this, this._ctx, this.state);
    this.enterRule(localctx, 64, FSHParser.RULE_vsFilter);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 321;
...
function FilterDefinitionContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = FSHParser.RULE_filterDefinition;
    return this;
}
...
FilterDefinitionContext.prototype.KW_SYSTEM = function() {
    return this.getToken(FSHParser.KW_SYSTEM, 0);
};

FilterDefinitionContext.prototype.filterOperator = function() {
    return this.getTypedRuleContext(FilterOperatorContext,0);
};

FilterDefinitionContext.prototype.filterValue = function() {
    return this.getTypedRuleContext(FilterValueContext,0);
};

FilterDefinitionContext.prototype.SEQUENCE = function(i) {
	if(i===undefined) {
		i = null;
	}
    if(i===null) {
...
FSHParser.FilterDefinitionContext = FilterDefinitionContext;

FSHParser.prototype.filterDefinition = function() {

    var localctx = new FilterDefinitionContext(this, this._ctx, this.state);
    this.enterRule(localctx, 66, FSHParser.RULE_filterDefinition);
    try {
        this.state = 336;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
function FilterOperatorContext(parser, parent, invokingState) {
	if(parent===undefined) {
	    parent = null;
	}
	if(invokingState===undefined || invokingState===null) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = FSHParser.RULE_filterOperator;
    return this;
}

FilterOperatorContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
FilterOperatorContext.prototype.constructor = FilterOperatorContext;

FilterOperatorContext.prototype.EQUAL = function() {
    return this.getToken(FSHParser.EQUAL, 0);
};

FilterOperatorContext.prototype.SEQUENCE = function() {
    return this.getToken(FSHParser.SEQUENCE, 0);
};

FilterOperatorContext.prototype.enterRule = function(listener) {
    if(listener instanceof FSHListener ) {
        listener.enterFilterOperator(this);
	}
};

FilterOperatorContext.prototype.exitRule = function(listener) {
    if(listener instanceof FSHListener ) {
        listener.exitFilterOperator(this);
	}
};

FilterOperatorContext.prototype.accept = function(visitor) {
    if ( visitor instanceof FSHVisitor ) {
...
FSHParser.FilterOperatorContext = FilterOperatorContext;

FSHParser.prototype.filterOperator = function() {

    var localctx = new FilterOperatorContext(this, this._ctx, this.state);
    this.enterRule(localctx, 68, FSHParser.RULE_filterOperator);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 338;
...
function FilterValueContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = FSHParser.RULE_filterValue;
    return this;
}
...
FilterValueContext.prototype.code = function() {
    return this.getTypedRuleContext(CodeContext,0);
};

FilterValueContext.prototype.REGEX = function() {
    return this.getToken(FSHParser.REGEX, 0);
};

FilterValueContext.prototype.COMMA_DELIMITED_SEQUENCES = function() {
    return this.getToken(FSHParser.COMMA_DELIMITED_SEQUENCES, 0);
};

FilterValueContext.prototype.SEQUENCE = function() {
    return this.getToken(FSHParser.SEQUENCE, 0);
};
...
FilterValueContext.prototype.accept = function(visitor) {
    if ( visitor instanceof FSHVisitor ) {
        return visitor.visitFilterValue(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
FSHParser.FilterValueContext = FilterValueContext;

FSHParser.prototype.filterValue = function() {

    var localctx = new FilterValueContext(this, this._ctx, this.state);
    this.enterRule(localctx, 70, FSHParser.RULE_filterValue);
    try {
        this.state = 344;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
FSHParser.prototype.path = function() {
    ...
    this.enterRule(localctx, 72, FSHParser.RULE_path);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 346;
        this.match(FSHParser.SEQUENCE);
...
FSHParser.prototype.paths = function() {
    ...
    this.enterRule(localctx, 74, FSHParser.RULE_paths);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 348;
        this.match(FSHParser.COMMA_DELIMITED_SEQUENCES);
...
FSHParser.prototype.caretPath = function() {
    ...
    this.enterRule(localctx, 76, FSHParser.RULE_caretPath);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 350;
...
FSHParser.prototype.flag = function() {
    ...
    this.enterRule(localctx, 78, FSHParser.RULE_flag);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 352;
...
FSHParser.prototype.strength = function() {
    ...
    this.enterRule(localctx, 80, FSHParser.RULE_strength);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 354;
...
FSHParser.prototype.value = function() {
    ...
    this.enterRule(localctx, 82, FSHParser.RULE_value);
    try {
        this.state = 365;
        this._errHandler.sync(this);
...
FSHParser.prototype.item = function() {
    ...
    this.enterRule(localctx, 84, FSHParser.RULE_item);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 367;
...
FSHParser.prototype.code = function() {
    ...
    this.enterRule(localctx, 86, FSHParser.RULE_code);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 375;
        this.match(FSHParser.CODE);
...
FSHParser.prototype.quantity = function() {
    ...
    this.enterRule(localctx, 88, FSHParser.RULE_quantity);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 379;
        this.match(FSHParser.NUMBER);
...
FSHParser.prototype.ratio = function() {
    ...
    this.enterRule(localctx, 90, FSHParser.RULE_ratio);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 382;
        this.ratioPart();
...
FSHParser.prototype.ratioPart = function() {
    ...
    this.enterRule(localctx, 92, FSHParser.RULE_ratioPart);
    try {
        this.state = 388;
        this._errHandler.sync(this);
...
FSHParser.prototype.bool = function() {
    ...
    this.enterRule(localctx, 94, FSHParser.RULE_bool);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 390;
...
FSHParser.prototype.targetType = function() {
    ...
    this.enterRule(localctx, 96, FSHParser.RULE_targetType);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 392;
