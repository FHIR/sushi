...
84,84,2,0,83,83,85,85,1,0,44,45,2,0,53,53,73,73,6,0,26,30,46,46,48,49,60,
60,64,64,73,73,1,0,25,30,1,0,32,35,1,0,61,62,1,0,42,43,3,0,26,31,36,49,52,
52,882,0,185,1,0,0,0,2,202,1,0,0,0,4,204,1,0,0,0,6,209,1,0,0,0,8,222,1,0,
0,0,10,237,1,0,0,0,12,252,1,0,0,0,14,270,1,0,0,0,16,282,1,0,0,0,18,287,1,
0,0,0,20,289,1,0,0,0,22,307,1,0,0,0,24,312,1,0,0,0,26,314,1,0,0,0,28,332,
1,0,0,0,30,337,1,0,0,0,32,339,1,0,0,0,34,356,1,0,0,0,36,363,1,0,0,0,38,365,
1,0,0,0,40,382,1,0,0,0,42,387,1,0,0,0,44,389,1,0,0,0,46,404,1,0,0,0,48,406,
1,0,0,0,50,410,1,0,0,0,52,419,1,0,0,0,54,421,1,0,0,0,56,423,1,0,0,0,58,430,
...
export default class FSHParser extends antlr4.Parser {
	...
	name() {
	    ...
	    try {
	        ...
	        this.state = 739;
	        _la = this._input.LA(1);
	        if(!((((_la) & ~0x1f) === 0 && ((1 << _la) & 2080374784) !== 0) || ((((_la - 46)) & ~0x1f) === 0 && ((1 << (_la - 46)) & 134496269) !== 0))) {
	        this._errHandler.recoverInline(this);
	        }
	        else {
	        	this._errHandler.reportMatch(this);
