...
ParamRuleSetContext.prototype.SEQUENCE = function() {
    return this.getToken(FSHParser.SEQUENCE, 0);
};

ParamRuleSetContext.prototype.PARAMETER_DEF_LIST = function() {
    return this.getToken(FSHParser.PARAMETER_DEF_LIST, 0);
};
...
FSHParser.prototype.paramRuleSet = function() {
    ...
    try {
        ...
        this.match(FSHParser.SEQUENCE);
        this.state = 316;
        this.match(FSHParser.PARAMETER_DEF_LIST);
        this.state = 317;
