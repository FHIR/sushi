...
var symbolicNames = [ null, "KW_ALIAS", "KW_PROFILE", "KW_EXTENSION", "KW_INSTANCE", 
                      ...
                      "PARAMETER_LIST", "SUBSTITUTION", "COMMA_DELIMITED_SEQUENCES", 
...
FSHParser.PARAMETER_LIST = 70;
FSHParser.SUBSTITUTION = 71;
FSHParser.COMMA_DELIMITED_SEQUENCES = 72;
FSHParser.SEQUENCE = 73;
FSHParser.WHITESPACE = 74;
FSHParser.BLOCK_COMMENT = 75;
FSHParser.LINE_COMMENT = 76;
...
RuleSetContext.prototype.PARAMETER_LIST = function() {
    return this.getToken(FSHParser.PARAMETER_LIST, 0);
};
...
FSHParser.prototype.ruleSet = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if(_la===FSHParser.PARAMETER_LIST) {
            this.state = 299;
            this.match(FSHParser.PARAMETER_LIST);
        }
...
ValueSetRuleContext.prototype.SUBSTITUTION = function() {
    return this.getToken(FSHParser.SUBSTITUTION, 0);
};
...
FSHParser.prototype.valueSetRule = function() {
    ...
    try {
        ...
        this.state = 415;
        _la = this._input.LA(1);
        if(!(_la===FSHParser.SUBSTITUTION || _la===FSHParser.SEQUENCE)) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if(((((_la - 29)) & ~0x1f) == 0 && ((1 << (_la - 29)) & ((1 << (FSHParser.KW_EXAMPLE - 29)) | (1 << (FSHParser.KW_PREFERRED - 29)) | (1 << (FSHParser.KW_EXTENSIBLE - 29)) | (1 << (FSHParser.KW_REQUIRED - 29)))) !== 0) || _la===FSHParser.SUBSTITUTION) {
            this.state = 416;
            this.strength();
        }
...
StrengthContext.prototype.SUBSTITUTION = function() {
    return this.getToken(FSHParser.SUBSTITUTION, 0);
};
