...
FSHParser.RULE_quantity = 49;
FSHParser.RULE_ratio = 50;
FSHParser.RULE_ratioPart = 51;
FSHParser.RULE_bool = 52;
FSHParser.RULE_targetType = 53;
...
CodeSystemContext.prototype.code = function(i) {
    if(i===undefined) {
        i = null;
    }
    if(i===null) {
...
FSHParser.prototype.quantity = function() {
    ...
    this.enterRule(localctx, 98, FSHParser.RULE_quantity);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 432;
        this.match(FSHParser.NUMBER);
...
FSHParser.prototype.ratio = function() {
    ...
    this.enterRule(localctx, 100, FSHParser.RULE_ratio);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 435;
        this.ratioPart();
...
FSHParser.prototype.ratioPart = function() {
    ...
    this.enterRule(localctx, 102, FSHParser.RULE_ratioPart);
    try {
        this.state = 441;
        this._errHandler.sync(this);
...
FSHParser.prototype.bool = function() {
    ...
    this.enterRule(localctx, 104, FSHParser.RULE_bool);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 443;
...
FSHParser.prototype.targetType = function() {
    ...
    this.enterRule(localctx, 106, FSHParser.RULE_targetType);
    var _la = 0; // Token type
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 445;
