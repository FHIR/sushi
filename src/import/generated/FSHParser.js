...
var literalNames = [ null, null, null, null, null, null, null, null, null, 
                     ...
                     null, "'contains'", "'named'", "'and'", "'only'", "'or'", 
                     "'obeys'", "'true'", "'false'", "'exclude'", "'codes'", 
                     "'where'", "'valueset'", "'system'", "'='", null, "':'", 
                     "','" ];
...
FSHParser.KW_NAMED = 27;
FSHParser.KW_AND = 28;
FSHParser.KW_ONLY = 29;
FSHParser.KW_OR = 30;
FSHParser.KW_OBEYS = 31;
FSHParser.KW_TRUE = 32;
FSHParser.KW_FALSE = 33;
FSHParser.KW_EXCLUDE = 34;
FSHParser.KW_CODES = 35;
FSHParser.KW_WHERE = 36;
FSHParser.KW_VSREFERENCE = 37;
FSHParser.KW_SYSTEM = 38;
FSHParser.EQUAL = 39;
FSHParser.STAR = 40;
FSHParser.COLON = 41;
FSHParser.COMMA = 42;
FSHParser.STRING = 43;
FSHParser.MULTILINE_STRING = 44;
FSHParser.NUMBER = 45;
FSHParser.UNIT = 46;
FSHParser.CODE = 47;
FSHParser.CONCEPT_STRING = 48;
FSHParser.DATETIME = 49;
FSHParser.TIME = 50;
FSHParser.CARD = 51;
FSHParser.REFERENCE = 52;
FSHParser.CARET_SEQUENCE = 53;
FSHParser.REGEX = 54;
FSHParser.COMMA_DELIMITED_CODES = 55;
FSHParser.COMMA_DELIMITED_SEQUENCES = 56;
FSHParser.SEQUENCE = 57;
FSHParser.WHITESPACE = 58;
FSHParser.BLOCK_COMMENT = 59;
FSHParser.LINE_COMMENT = 60;
...
FSHParser.prototype.vsFilterDefinition = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if(((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (FSHParser.KW_TRUE - 32)) | (1 << (FSHParser.KW_FALSE - 32)) | (1 << (FSHParser.STRING - 32)) | (1 << (FSHParser.CODE - 32)) | (1 << (FSHParser.REGEX - 32)))) !== 0)) {
            this.state = 417;
            this.vsFilterValue();
        }
